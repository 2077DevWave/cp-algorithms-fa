...
- July 16, 2024: Major overhaul of the [Finding strongly connected components / Building condensation graph](https://cp-algorithm.sideco.ir/graph/strongly-connected-components.html) article.
- June 26, 2023: Added automatic RSS feeds for [new articles](https://cp-algorithm.sideco.ir/feed_rss_created.xml) and [updates in articles](https://cp-algorithm.sideco.ir/feed_rss_updated.xml).
...
- (21 May 2025) [Simulated Annealing](https://cp-algorithm.sideco.ir/num_methods/simulated_annealing.html)
- (12 July 2024) [Manhattan distance](https://cp-algorithm.sideco.ir/geometry/manhattan-distance.html)
- (8 June 2024) [Knapsack Problem](https://cp-algorithm.sideco.ir/dynamic_programming/knapsack.html)
- (28 January 2024) [Introduction to Dynamic Programming](https://cp-algorithm.sideco.ir/dynamic_programming/intro-to-dp.html)
- (8 December 2023) [Hungarian Algorithm](https://cp-algorithm.sideco.ir/graph/hungarian-algorithm.html)
- (10 September 2023) [Tortoise and Hare Algorithm](https://cp-algorithm.sideco.ir/others/tortoise_and_hare.html)
- (12 July 2023) [Finding faces of a planar graph](https://cp-algorithm.sideco.ir/geometry/planar.html)
- (18 April 2023) [Bit manipulation](https://cp-algorithm.sideco.ir/algebra/bit-manipulation.html)
- (17 October 2022) [Binary Search](https://cp-algorithm.sideco.ir/num_methods/binary_search.html)
- (17 October 2022) [MEX (Minimum Excluded element in an array)](https://cp-algorithm.sideco.ir/sequences/mex.html)
- (12 May 2022) [Factoring Exponentiation](https://cp-algorithm.sideco.ir/algebra/factoring-exp.html)
- (7 May 2022) [Knuth's Optimization](https://cp-algorithm.sideco.ir/dynamic_programming/knuth-optimization.html)
- (31 March 2022) [Continued fractions](https://cp-algorithm.sideco.ir/algebra/continued-fractions.html)

Full list of updates: [Commit History](https://github.com/2077DevWave/cp-algorithms-fa/commits/main)

Full list of articles: [Navigation](https://cp-algorithm.sideco.ir/navigation.html)
